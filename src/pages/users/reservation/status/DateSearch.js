...
const DateSearch = () => {
  ...
  const [date, setDate] = useState({ start: moment().day(-90), end: moment() });
  ...
  return (
    <>
      ...
      >
        <Radio style={{ color: '#7E8299', margin: '0' }} value={7}>
          7일
        </Radio>
        <Radio style={{ color: '#7E8299', margin: '0' }} value={30}>
          30일
        </Radio>
        <Radio style={{ color: '#7E8299', margin: '0' }} value={90}>
          90일
        </Radio>
      </Radio.Group>
    </>
